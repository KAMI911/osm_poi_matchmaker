...
CREATE INDEX IF NOT EXISTS i_planet_osm_point_amenity_addr_lower ON planet_osm_point("osm_id",LOWER("amenity"),LOWER("name"),LOWER("brand"),LOWER("addr:street"));
CREATE INDEX IF NOT EXISTS i_planet_osm_point_highway_addr_lower ON planet_osm_point("osm_id",LOWER("highway"),LOWER("name"));
...
CREATE INDEX IF NOT EXISTS i_planet_osm_point_amenity ON planet_osm_point(highway);
...
CREATE INDEX IF NOT EXISTS i_planet_osm_line_amenity_addr_lower ON planet_osm_line("osm_id",LOWER("amenity"),LOWER("name"),LOWER("brand"),LOWER("addr:street"));
CREATE INDEX IF NOT EXISTS i_planet_osm_line_highway_addr_lower ON planet_osm_line("osm_id",LOWER("highway"),LOWER("name"));
...
CREATE INDEX IF NOT EXISTS i_planet_osm_line_amenity ON planet_osm_line(highway);
...
CREATE INDEX IF NOT EXISTS i_planet_osm_polygon_amenity_addr_lower ON planet_osm_polygon("osm_id",LOWER("amenity"),LOWER("name"),LOWER("brand"),LOWER("addr:street"));
CREATE INDEX IF NOT EXISTS i_planet_osm_polygon_highway_addr_lower ON planet_osm_polygon("osm_id",LOWER("highway"),LOWER("name"));
...
CREATE INDEX IF NOT EXISTS i_planet_osm_polygon_amenity ON planet_osm_polygon(highway);
