...
def extract_street_housenumber_better_2(clearable):
    ...
    if clearable is not None and clearable != '':
        ...
        # Fixing Budapest Bank data provider
        ...
        # Fix Mobil Petrol data provider
        street = street.replace('Nyúl 82. sz. főút', 'Kossuth Lajos út')
        # Fix OMV & MOL data provider
        ...
        street = street.replace('Fehérvári út (Andor u. 1.) út', 'Fehérvári út')
