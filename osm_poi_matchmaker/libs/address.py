...
def clean_street(clearable):
    ...
    street = clearable.replace('. sz. fkl.út', '. számú főközlekedési út')
    ...
    street = street.replace(' sz. főút', '. számú főközlekedési út')
    street = street.replace('Budafoki út, 6-os sz. számú főközlekedési út', '6. számú főközlekedési út')
    ...
    street = street.replace('Déli pu.', 'Déli pályaudvar')
    return street