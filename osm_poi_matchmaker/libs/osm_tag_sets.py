...
POS_OTP = {'payment:contactless': 'yes', 'payment:mastercard': 'yes',
...
POS_HU_GEN = {'payment:contactless': 'yes', 'payment:mastercard': 'yes', 'payment:visa': 'yes',
              'payment:mastercard_electronic': 'yes', 'payment:maestro': 'yes', 'payment:visa_electron': 'yes',
