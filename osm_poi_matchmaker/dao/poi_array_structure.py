...
POI_COLS_RAW = ['poi_code', 'poi_postcode', 'poi_city', 'poi_name', 'poi_branch',
            ...
            'poi_ref', 'poi_additional_ref', 'poi_gtfs_parent_station', 'poi_gtfs_location_type',
            'poi_uic_ref', 'poi_wikidata',
            'poi_phone', 'poi_mobile', 'poi_email',
            'poi_geom',
