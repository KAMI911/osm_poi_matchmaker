...
class hu_aldi(DataProvider):
    ...
    def constains(self):
        ...
        self.POI_COMMON_TAGS = "'operator': 'ALDI Magyarország Élelmiszer Bt.', 'operator:addr': '2051 Biatorbágy, Mészárosok útja 2.', 'brand': 'Aldi', 'ref:vatin:hu':'22234663-2-44', 'ref:vatin':'HU22234663', ,'brand:wikipedia':'hu:Aldi', ,'brand:wikidata':'Q125054', 'addr:country': 'HU', 'contact:facebook': 'https://www.facebook.com/ALDI.Magyarorszag', 'contact:youtube':'https://www.youtube.com/user/ALDIMagyarorszag', 'contact:instagram':'https://www.instagram.com/aldi.magyarorszag', 'payment:mastercard': 'yes', 'payment:visa': 'yes', 'air_conditioning': 'yes'}"
