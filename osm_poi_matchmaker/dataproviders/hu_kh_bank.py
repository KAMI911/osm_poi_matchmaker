        ...
        if self.link:
            with open(self.link, 'r') as f:
                ...
                for poi_data in text['results']:
                    ...
                    t = OpeningHours(nonstop, mo_o, th_o, we_o, tu_o, fr_o, sa_o, su_o, mo_c, th_c, we_c, tu_c, fr_c,
                                     sa_c, su_c, summer_mo_o, summer_th_o, summer_we_o, summer_tu_o, summer_fr_o,
