    ...
    def types():
        data = [{'poi_code': 'hupostapo', 'poi_name': 'Posta', 'poi_type': 'post_office',
                ...
                {'poi_code': 'hupostacso', 'poi_name': 'Posta csomagautomata',
                 ...
                 'poi_url_base': 'https://www.posta.hu', 'poi_search_name': '(mpl|posta)', 'osm_search_distance_perfect': 2000, 'osm_search_distance_safe': 200},
                {'poi_code': 'hupostapp', 'poi_name': 'PostaPont', 'poi_type': 'post_office',
                 'poi_tags': "{'amenity': 'post_office', " + POI_COMMON_TAGS + "}",
                 'poi_url_base': 'https://www.posta.hu', 'poi_search_name': '(postapont|posta)', 'osm_search_distance_perfect': 2000, 'osm_search_distance_safe': 200},
                {'poi_code': 'hupostamp', 'poi_name': 'Mobilposta', 'poi_type': 'post_office',
                 'poi_tags': "{'amenity': 'post_office', " + POI_COMMON_TAGS + "}",
                 'poi_url_base': 'https://www.posta.hu', 'poi_search_name': 'posta', 'osm_search_distance_perfect': 2000, 'osm_search_distance_safe': 200}]
        return data
